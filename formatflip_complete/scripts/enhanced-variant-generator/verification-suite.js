...
function generateVariant() {
  ...
  try {
    // Use the correct path to the create-variant.js script
    const projectRoot = path.resolve(process.cwd(), '../..');
    const command = `cd ${projectRoot} && node scripts/create-variant.js --name=${TEST_VARIANT_NAME} --mode=${TEST_CONVERSION_MODE} --color=${TEST_COLOR} --transformer=${AST_TRANSFORMER_MODE}`;
