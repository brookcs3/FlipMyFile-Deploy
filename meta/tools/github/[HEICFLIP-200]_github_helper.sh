#!/bin/bash
#
# [HEICFLIP-200] GitHub Helper Script
#
# Purpose: Core helper functions for GitHub operations
#          This script ensures we always use the correct GitHub token
#
# Usage: source ./meta/tools/github/[HEICFLIP-200]_github_helper.sh
#
# Options:
#   When run directly with no arguments, displays help information
#
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  ...
  echo ""
  echo "Example usage:"
  echo "  source ./meta/tools/github/[HEICFLIP-200]_github_helper.sh"
