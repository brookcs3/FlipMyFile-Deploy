...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (siteConfig.defaultConversionMode === 'heicToJpg') {
      title = "FlipMyFile - Free HEIC to JPG Converter - Instant Online Conversion";
      description = "Convert HEIC images to JPG format instantly online with FlipMyFile. Fast, free, secure HEIC to JPG converter. No signup required.";
    } else {
      title = "FlipMyFile - Free JPG to HEIC Converter - Instant Online Conversion";
      description = "Convert JPG images to HEIC format instantly online with FlipMyFile. Fast, free, secure JPG to HEIC converter. No signup required.";
    }
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-8">
              ...
              <div className="mt-2 flex justify-center space-x-4">
                ...
                <a href="/auto-detect" className="text-sm text-blue-500 hover:text-blue-700 underline">
