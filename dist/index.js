...
async function registerRoutes(app2) {
  ...
  app2.get("/format-demo", (req, res) => {
    res.sendFile(path.resolve(process.cwd(), "format-transformation-demo.html"));
  });
  app2.get("/ffmpeg-demo", (req, res) => {
    res.sendFile(path.resolve(process.cwd(), "ffmpeg-demo.html"));
  });
  app2.use("/scripts", express.static("scripts"));
  app2.use("/ffmpeg-core.js", express.static("ffmpeg-core.js"));
  app2.use("/ffmpeg-core.wasm", express.static("ffmpeg-core.wasm"));
  app2.use("/ffmpeg-core.worker.js", express.static("ffmpeg-core.worker.js"));
  app2.use("/ffmpeg.min.js", express.static("ffmpeg.min.js"));
  app2.get("/api/formats", (req, res) => {
    res.json({
